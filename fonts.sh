...
sudo apt-get install fonts-adf-tribun                    
...
sudo apt-get install fonts-oflb-euterpe
...
sudo apt-get install fonts-century-catalogue             
...
sudo apt-get install fonts-smc-raghumalayalamsans
...
sudo apt-get install fonts-thai-tlwg-otf
...
sudo apt-get install fonts-linex                        
...
sudo apt-get install fonts-lohit-gujr                   
sudo apt-get install fonts-yanone-kaffeesatz
sudo apt-get install fonts-lohit-guru 
...
sudo apt-get install fonts-yozvox-yozfont-new-kana
sudo apt-get install fonts-lohit-taml-classical          
sudo apt-get install fonts-lohit-telu                   
sudo apt-get install fonts-yrsa-rasa
